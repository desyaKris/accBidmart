                  ...
                  <div class="alert alert-info">
                    <form action="{{url('/editApprovalChangesUserPending')}}"  method="POST" enctype="multipart/form-data">
                      ...
                      <?php foreach ($response as $dt): ?>
                        ...
                        <div class="form-group row">
                          <label class="col-sm-2 col-form-label">UserAdded</label>
                          <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                          <label class="col-sm-2 col-form-label">UserAdded</label>
                          <div class="col-sm-6">
                            <?php if (!empty($dt['UserAdded'])): ?>
                              <label class="col-sm-5 col-form-label" name="UserAdded" value="{{$dt['UserAdded']}}">{{$dt['UserAdded']}}</label>
                            <?php endif; ?>
                          </div>
                        </div>
                      ...
                      <div class="form-group row">
                        <div class="col-sm-3">
                          ...
                          <button type="submit" name="action" value="Renew" class="btn btn-primary">Renew</button>
                        </div>
                      </div>
                      </form>
